          ...
          <div className="container mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div>
                  ...
                  <p className="text-sm text-gray-400">
                      Welcome to our Unicare treatment center! Discover a variety of Ayurvedic products and more at amazing prices. All designed to support your health and well-being.
                  </p>
              </div>
              ...
              <div>
                  ...
                  <ul className="space-y-2">
                      ...
                      <li><a href="#menu" className="hover:text-red-500 transition">Appointment</a></li>
                      <li><a href="#about" className="hover:text-red-500 transition">Treatment Updates</a></li>
                      <li><a href="#menu" className="hover:text-red-500 transition">Instruction blogs</a></li>
                  </ul>
              </div>
              ...
              <div>
                  ...
                  <p className="text-sm text-gray-400">Email: support@Unicarestore.com</p>

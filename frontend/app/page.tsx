...
import { FaLeaf, FaSpa, FaHeartbeat, FaUserMd, FaFacebook, FaInstagram, FaTwitter, FaPhone, FaEnvelope, FaMapMarkerAlt } from "react-icons/fa";
import "swiper/css";
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">
              At Unicare Ayurveda, we combine ancient wisdom with modern understanding to provide
              holistic healing solutions. Our experienced practitioners are dedicated to helping you
              achieve optimal health and wellness through personalized Ayurvedic treatments.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              Contact us today to schedule a consultation and discover how Ayurvedic healing
      ...
      <footer className="bg-gray-900 text-gray-300">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Unicare Ayurveda</h3>
              <p className="text-gray-400 mb-4">
                Your journey to holistic wellness begins here. Experience the ancient wisdom of Ayurveda.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              © {new Date().getFullYear()} Unicare Ayurveda. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
